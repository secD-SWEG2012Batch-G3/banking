...
int main()
{
    ...
    while (isDone)
    {
        ...
        cout << "    Enter 9 for administration access.\n";
...
void create_acc()
{
    ...
    cout << "Enter government ID or passport  or driving licence: ";
...
void showAll()
{
    cout << setw(15)<<"Name"<<setw(15)<<"City"<<setw(15)<<"Woreda"<<setw(15)<<"House Number"<<setw(15)<<"Birth date";
    cout << setw(15)<<"ID"<<setw(15)<<"Account number"<<setw(15)<<"Amount"<<endl;
    for(int i=0;i<counter;i++){
    cout << setw(15)<< client[i]->name;
    cout << setw(15)<< client[i]->addr.city;
    cout << setw(15)<< client[i]->addr.woreda;
    cout << setw(15)<< client[i]->addr.house_num;
    cout << setw(15)<< client[i]->birth.date<<"/"<< client[i]->birth.month<<"/"<< client[i]->birth.year;
    cout << setw(15)<< client[i]->id, 20;
    cout << setw(15)<< client[i]->accountNum;
    cout << setw(15)<< client[i]->amount;
    cout<<endl;
    }
}
void above5000()
...
void adminAccess()
{
    ...
    int choice;
    int adminPassword;
    cout<<"Enter your administration password: ";
    cin>>adminPassword;
    ...
    if (adminPassword==333)
    {
        ...
        choice:
        cout << "\n  ****************Menu**************************\n";
        cout << "    Enter 1 to show all customer information.\n";
        cout << "    Enter 2 to show all customer information who have above 5000 birr.\n";
        cout << "    Enter 3 to show all customer information who have below 5000 birr.\n";\
        cout << "    Enter 0 to exit.\n";
        cin >> choice;
